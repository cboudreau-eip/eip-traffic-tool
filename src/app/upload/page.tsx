    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="mt-1 text-sm text-gray-500">
          Import GSC exports, GA4 reports, sitemaps, or any spreadsheet
        </p>
      </div>
        ...
        <CardContent>
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { label: "XML Sitemap", desc: "URLs, last modified dates, change frequency, priority", ext: ".xml" },
              ...
              <div key={item.label} className="rounded-lg border border-gray-100 bg-gray-50 p-4">
                ...
                <p className="mt-2 text-xs font-mono text-orange-500">{item.ext}</p>
              </div>
            ))}
          </div>
        </CardContent>
          ...
          <CardContent>
            <div className="space-y-2">
              {uploads.map((u) => (
                <div
                  key={u.id}
                  className="flex items-center gap-3 rounded-lg border border-gray-100 px-4 py-3 hover:bg-gray-50"
                >

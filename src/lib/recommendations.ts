  ...
  return rows
    ...
    .map((r) => {
      ...
      return {
        ...
        tag: "Ranking",
        tagColor: "bg-md-tertiary-container text-md-on-tertiary-container",
  ...
  return rows
    ...
    .map((r) => {
      ...
      return {
        ...
        priority: getPriority(estimatedGain),
        tag: "CTR",
        tagColor: "bg-md-primary-container text-md-on-primary-container",
  ...
  return rows
    ...
    .map((r) => {
      ...
      return {
        ...
        priority: getPriority(estimatedGain),
        tag: "Visibility",
        tagColor: "bg-md-secondary-container text-md-on-secondary-container",
  ...
  return rows
    ...
    .map((r) => {
      ...
      return {
        ...
        priority: getPriority(estimatedGain),
        tag: "Engagement",
        tagColor: "bg-md-error-container text-md-on-error-container",
...
export function buildDecliningTrafficRecs(rows: Ga4DateRow[]): Recommendation[] {
  ...
  for (const [pagePath, dateMap] of pageSessionsByDate) {
    ...
    recs.push({
      ...
      priority: getPriority(estimatedGain),
      tag: "Trend",
      tagColor: "bg-md-surface-container-high text-md-on-surface-variant",
